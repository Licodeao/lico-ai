...
const EditSetting: FC<IProps> = () => {
  ...
  const options = [
    { label: "Youtube", ratio: "16:9", value: 1 },
    { label: "Youtube Short", ratio: "9:16", value: 2 },
    { label: "抖音", ratio: "9:16", value: 3 },
    { label: "快手", ratio: "9:16", value: 4 },
    { label: "微博", ratio: "16:9", value: 5 },
    { label: "X (Twitter)", ratio: "1:1", value: 6 },
