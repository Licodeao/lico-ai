...
import MediaRecordSvg from "@/assets/img/mediaRecord.svg";
    ...
    <div className="p-6 flex flex-col gap-8 font-semibold text-[#1A2033]">
      ...
      <div className="flex flex-col justify-center items-center gap-3">
        <div className="border border-[#DFE0E5] border-dashed w-full h-40 rounded-md hover:border-[#2C98FA] hover:bg-[#F0F9FF]">
          <input
            type="file"
            accept="video/mp4,.mp4,video/quicktime,.mov,video/x-msvideo,.avi,video/webm,.webm,video/x-ms-wmv,.wmv,video/x-matroska,.mkv,video/avi,.avi,video/mpeg,.mpg,video/3gpp,.3gp,video/*,.mkv,.3gp,.flv,.ts,.veedio,.veedrecovery,image/gif,.gif,audio/mp4,.mp4,audio/mpeg,.mpg,audio/*,.aac,.wav,.m4a,.mp3,image/*,.jpg,.jpeg,.png,.webp,.gif"
            style={{ display: "none" }}
            multiple
            id="file"
          />
        ...
        <div className="w-full grid grid-cols-2 grid-rows-2 gap-4">
          <div className="h-32 border border-[#EEEEF0] hover:border-[#72C1FD] rounded-lg flex flex-col justify-center items-center gap-2 row-span-2">
            <img src={MediaRecordSvg} alt="mediaRecord" />
            <span className="text-sm font-normal">录制</span>
          </div>
          <div className="h-32 border border-[#EEEEF0] hover:border-[#72C1FD] rounded-lg flex flex-col justify-center items-center gap-2 row-span-2">
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-row justify-between items-center">
          <h4 className="font-normal">视频素材</h4>
        ...
        <div className="flex flex-row justify-between items-center">
          <h4 className="font-normal">AI 角色</h4>
          <span className="text-xs text-[#9194A5] font-normal hover:text-[#72C1FD]">
            查看更多
          </span>
        </div>
        ...
        <div className="flex flex-row justify-between items-center">
          <h4 className="font-normal">音频素材</h4>
          <span className="text-xs text-[#9194A5] font-normal hover:text-[#72C1FD]">
            查看更多
          </span>
        </div>
